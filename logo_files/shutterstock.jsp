	...
	usi_analytics = {
		...
		usi_app.main = function () {
			try { // General
				...
				usi_app.is_german_language = usi_app.url_href.match("/de/") != null;
		...
		usi_app.load = function () {
			...
			try {
				...
				if (!usi_app.is_existing_customer && usi_app.is_footage_in_cart && !usi_date.is_between('2021-11-28T16:01:00', '2021-12-10T15:59:00')) {
				...
				} else if (!usi_app.is_existing_customer && usi_app.is_english && usi_app.is_footage_in_cart && usi_date.is_between('2021-11-28T16:01:00', '2021-12-09T15:59:00')) {
					// Sitewide events
					usi_commons.log('[ load ] * * * Load Sitewide Events TT [Q4] * * *');
		...
		usi_app.is_image = function() {
			try {
				if (location.href.indexOf("/images") != -1 || location.href.indexOf("/image-photo/") || location.href.indexOf("/image-illustration/") != -1
				...
				if (typeof (usi_app.interval_id) === "undefined") {
					usi_app.interval_id = setInterval(function () {
						...
						if (usi_split_test.get_group(control_site_id) == '1') {
							...
							if (((usi_app.is_image() && location.href.indexOf("/purchase") != -1) || usi_app.is_image_in_cart || usi_app.is_image_page)) {
								usi_commons.log("Split Group: USI");
								usi_cookies.set("usi_cart_contains_image", "true", 24 * 60 * 60, true);
								usi_app.is_image_in_cart = true;
								// free trial image TT
								usi_commons.log('[ load ] * * * Load Free Trial Images TT * * *');
								usi_commons.load_view("2roFx5LIUYq3GPop084SAOk", "36825", usi_commons.device);
							}
						} else {
